    ...
    return (
      <div className="py-16">
        <EmptyState
          ...
          description="Start by entering your skill profile through the onboarding wizard, or load the seeded demo student (Suny Ranjan Verma) with a single click."
          actionText="Load Suny Ranjan Verma Demo Profile"
